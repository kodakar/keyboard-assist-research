...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\columnwidth]{keyboard_mapping.png}
...
なお，Long Short-Term Memory（LSTM）\cite{hochreiter1997long}，
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\columnwidth]{data_collection_setup.png}
\caption{データ収集の実験環境}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\columnwidth]{realtime_prediction.png}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\linewidth]{importance.png}
