...
図\ref{fig:feature_structure}に示すように，18次元の特徴量は，
...
\begin{figure}[tb]
\centering
\fbox{feature structure 18dim.png}
...
\begin{figure}[tb]
\centering
\fbox{data collection setup.png}
\caption{データ収集の実験環境}
...
\textbf{オフライン評価:}
学習済みモデルをテストセット（950サンプル）で評どの情報機器は，現代社会において不可欠なコミュニケーション手段である．価し，
以下の指標を測定した．
...
各モデルの基本的な認識性能を測定した．
図\ref{fig:learning_curves}に各モデルの学習曲線を示す．
いずれのモデルも訓練損失と検証損失が安定して収束しており，
適切に学習できていることが確認できる．
