...
\begin{figure}[tb]
\centering
\includegraphics[width=0.9\columnwidth]{realtime_prediction.png}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.9\linewidth]{importance.png}
...
GRUがオフライン精度98.0\%，リアルタイム精度100.0\%（予備実験）と最も優れた性能を示した．
実用性評価では，通常入力と振戦模擬入力の2条件で評価を実施し，
振戦を模擬した条件下においても誤入力時の救済率65.0\%，Top-3精度90.0\%を達成した．
これは，ユーザーが誤ったキーを押下した場合でも，
